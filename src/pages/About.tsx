          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                At Rumin, we believe that finding a place to call home should be
                simple, transparent, and stress-free. Our platform connects
                renters with verified rooms and trusted landlords, making the
                rental process seamless and efficient.
              </p>
              <p className="text-gray-600 leading-relaxed">
                We're committed to providing a user-friendly experience that
                lets you search by location, budget, and preferences, ensuring
                you find the perfect space quickly and effortlessly.
              </p>
            </div>
            <div className="bg-blue-100 rounded-2xl p-8">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Landlords Served</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-600 mb-2">
                    {properties}+
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  All our listings are verified, and landlords go through a
                  thorough verification process to ensure your safety.
                </p>
              </div>
              <div className="text-center p-6">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600">
                  Find your perfect room in minutes with our smart search and
                  filter options designed for quick results.
                </p>
              </div>
              <div className="text-center p-6">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="bg-blue-600 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-white/90 mb-8">
              Join thousands of happy renters who found their ideal
              accommodation through Rumin.
            </p>
