            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-700 text-lg"> Rolta Incubation center MANIT, Bhopal</span>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-700 text-lg">+91 7024441045</span>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-700 text-lg">support@rumin.in</span>
                </div>
              </div>
            </div>
          </div>
